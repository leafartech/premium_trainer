    ...
    <div className="overflow-hidden">
      ...
      <main>
        <Section>
          ...
          <TimeLine
            txt1={{ title: 'Contato', description: 'Em até 72h após o pagamento, entrarei em contato diretamente com você para marcarmos a melhor data para a sua consulta.' }}
            ...
            txt4={{ title: 'Entrega', description: 'Dentro de 72 horas após a consultoria, você receberá o acesso do aplicativo para visualizar o seu treino personalizado.' }}
          />
        </Section>
        <Section>
          <div className="mb-2">
