                        ...
                        {typeof data?.product !== 'undefined' && data?.product[data?.product.length - 1] === 'consultoria-online' && (
                            <div className="py-4 mt-4 border border-dashed border-red-500 bg-red-400/20 rounded-md text-left px-4 sm:text-center">
                                ...
                                <p className="text-red-500">
                                    1. Responda a estas perguntas: <a href="https://docs.google.com/document/d/1_p2GOJkF8AAZwnJYAu3AkdXmjvUkGp21y4qjm-agVW4/edit?usp=sharing" target="_blank" className="font-medium underline">link</a>
                                </p>
                                <p className="text-red-500">
                                    2. Envie as seguintes fotos: <a href="./docs/images.pdf" target="_blank" className="font-medium underline">link</a>
                                </p>
