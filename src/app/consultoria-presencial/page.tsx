...
const ConsultoriaPresencial = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        <H2 header={true}>
          <span className="text-brandRed-500">Treinamento</span> feito sob a sua
          medida
        </H2>
      </Header>
      <main className="-t">
        <Section>
          ...
          <TimeLine
            txt1={{
              title: 'Contato',
              description:
                'Em até 72h após o pagamento, entrarei em contato diretamente com você para marcarmos a melhor data para a sua consultoria.',
            }}
            txt2={{
              title: 'Análise de objetivos',
              description:
                'Chegada a data da consultoria, teremos uma conversa detalhada para analisar seu caso e criar uma estratégia exclusiva, direcionada às suas metas.',
            }}
            txt3={{
              title: 'Avaliação física',
              description:
                'Realizaremos uma dupla avaliação física (bioimpedância e antropométrica) para termos uma referência inicial.',
            }}
            txt4={{
              title: 'Avaliação postural',
              description:
                'Para finalizar, uma avaliação postural para descobrir possíveis desníveis, encurtamentos e desequilíbrios de forças.',
            }}
          />
        </Section>
        <Section>
        ...
        <Section>
          <PurchaseCard
            ...
            valueOn="207"
            hrefList={[
              'https://pay.kiwify.com.br/h61XBU7',
