...
const AvaliacaoFisica = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        <H2 header={true}>
          <span className="text-brandRed-500">Mapeando o físico:</span> conheça
          o seu corpo!
        </H2>
      </Header>
      <main>
        <Section>
          ...
          <TimeLine
            txt1={{
              ...
              description:
                'Em menos de 3 minutos, você consegue agendar a melhor data para você utilizando nosso sistema inteligente.',
            }}
            txt2={{
              title: 'Avaliação',
              description:
            ...
            txt3={{
              title: 'Relatório',
              description:
                'Um relatório de toda a avaliação é entregue para que o guarde consigo como referência do seu físico atual.',
            }}
          />
        </Section>
        <Section>
