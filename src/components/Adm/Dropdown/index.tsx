...
const Dropdown = ({ days, objective, product, id, elementClicked, telephoneNumber, hour }: DropdownProps) => {
  ...
  return (
    ...
    >
      ...
      {days && (
        <div>
          <h2 className="text-emerald-500 text-xs font-semibold">
            {days} DIAS PARA A CONSULTA.
          </h2>
        </div>
      )}
    </div>
