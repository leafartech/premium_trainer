...
const ServicesBox = () => {
  return (
    <div className="w-full flex flex-col space-y-6 items-center justify-center">
      <div className="border-gradient-50 flex justify-between w-full p-4">
      ...
      <div className="border-gradient-70 flex justify-between w-full p-4">
      ...
      <div className="border-gradient-100 flex justify-between w-full p-4">
