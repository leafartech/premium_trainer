    ...
    <>
      ...
      <ul
        className={`sm:ms-24 transition duration-300 w-screen space-y-4 top-0 p-4 bg-black absolute min-h-screen md:min-h-full md:bg-transparent md:transform-none
         md:p-3 md:w-[700px] md:flex md:h-full md:relative md:space-y-0 md:justify-around md:right-4 md:items-center ${!navbarToggle ? "translate-x-full" : "translate-x-0"
          } `}
      >
        <li>
          <Link
        ...
        <li>
          <Link
            href="/cliente/login-cliente"
            className={`${router.pathname === "/cliente/login-cliente"
              ? "text-white font-bold"
              : "text-white/60"
              } trasition hover:text-white font-medium flex gap-2 items-center`}
          >
