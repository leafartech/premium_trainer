...
const TimeLine = ({ txt1, txt2, txt3, txt4 }: TimeLineProps) => {
  return (
    <div className="w-full flex justify-start px-2 mt-4">
      ...
      >
        <svg
          className="h-6 w-6 text-brandRed-500 absolute -bottom-4 left-[-10px] md:left-[-10px]"
          viewBox="0 0 24 23"
          fill="none"
      ...
      <div className="flex flex-col items-start gap-6">
        <div>
          ...
          <p className="text-zinc-300 ms-11 md:text-base text-sm text-justify sm:w-[500px]">{txt1.description}</p>
        </div>
        <div>
          <div className="relative ps-8 w-full flex justify-start">
            <div className="absolute left-0 bottom-1 w-6 h-6 border-l-[3px] border-dashed border-l-brandRed-500 -rotate-90"></div>
          ...
          <p className="text-zinc-300 ms-11 md:text-base text-sm text-justify sm:w-[500px]">{txt2.description}</p>
        </div>
        <div>
          <div className="relative ps-8 w-full flex justify-start">
            <div className="absolute left-0 bottom-1 w-6 h-6 border-l-[3px] border-dashed border-l-brandRed-500 -rotate-90"></div>
          ...
          <p className="text-zinc-300 ms-11 md:text-base text-sm text-justify sm:w-[500px]">{txt3.description}</p>
        </div>
        {txt4 && (
          <div>
            <div className="relative ps-8 w-full flex justify-start">
            ...
            <p className="text-zinc-300 ms-11 md:text-base text-sm text-justify sm:w-[500px]">{txt4.description}</p>
          </div>
        )}
      </div>
    </div>
