...
const TimeLine = () => {
  return (
    <div className="w-full flex justify-start px-2 mt-4">
      <div className="h-[450px] md:h-[350px] bg-brandRed-500 rounded-t w-3 sm:w-1 relative">
        <FaCaretDown
          size={32}
          className="text-brandRed-500 absolute -bottom-4 left-[-13px] md:left-[-14px]"
        />
      </div>
      <div className="flex flex-col items-center gap-6">
        <div>
          ...
          <p className="text-zinc-300 ms-11 md:text-base text-sm text-justify">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam,
            nobis, asperiores accusantium repellendus maxime
          </p>
        </div>
        <div>
          <div className="relative ps-8 w-full flex justify-start">
