...
const Header = ({ topTitle, ctaText, ctaHref, description, children, imageHeaderPath }: HeaderProps) => {
  return (
    <header className="relativ h-[820px] sm:min-h-screen sm:flex sm:flex-row-reverse sm:items-center sm:justify-center sm:gap-12">
      <Navbar />
      ...
      <div className="absolute top-16 flex flex-col justify-center items-center w-full sm:opacity-0">
        <h3 className="p-1 text-center uppercase tracking-[6px] text-xs text-brandWhite">{topTitle}</h3>
