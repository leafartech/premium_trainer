...
const ComparisionBox = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center gap-8 md:flex-row relative">
      <div className="flex flex-col max-h-96 bg-brandWhite rounded-md overflow-hidden pb-4 space-y-4">
        ...
        <div className="flex flex-col gap-3 py-6">
          <div className="flex justify-start items-center gap-2 py-3 px-4">
            ...
            />
            <p className="md:text-lg">Quem é preguiçoso</p>
          </div>
          <div className="flex justify-start items-center gap-2 py-3 px-4">
            <img
              src="./images/xIcon3.png"
              ...
              className="h-5 w-5 md:h-8 md:w-8"
            />
            <p className="md:text-lg">Quem não quer mudar de vida</p>
          </div>
          <div className="flex justify-start items-center gap-2 py-3 px-4">
            <img
              src="./images/xIcon3.png"
              ...
              className="h-5 w-5 md:h-8 md:w-8"
            />
            <p className="md:text-lg">Quem quer ficar na zona de conforto</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-3 py-6">
          <div className="flex justify-start items-center gap-2 py-3 px-4">
            <img
              ...
              className="h-5 w-5 md:h-8 md:w-8"
            />
            <p className="md:text-lg">Tem força de vontade</p>
          </div>
          <div className="flex justify-start items-center gap-2 py-3 px-4">
            <img
              src="./images/checkIcon2.png"
              ...
              className="h-5 w-5 md:h-8 md:w-8"
            />
            <p className="md:text-lg">Quer mudar de vida</p>
          </div>
          <div className="flex justify-start items-center gap-2 py-3 px-4">
            <img
              src="./images/checkIcon2.png"
              ...
              className="h-5 w-5 md:h-8 md:w-8"
            />
            <p className="md:text-lg">Quer melhorar a saúde</p>
          </div>
        </div>
      </div>
    </div>
