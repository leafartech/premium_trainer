...
const ComparisionBox = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center gap-8 md:flex-row relative">
      ...
      <div className="w-14 h-14 flex justify-center items-center -translate-y-18 rounded-full bg-brandWhite border-2 text-brandWhite absolute md:translate-x-3 md:translate-y-0">
